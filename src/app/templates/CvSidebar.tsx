...
export default function CvSidebar({ templateProps, cvProps, onShowWelcome }: Props) {
  const { templates, activeTemplate, activeLayout, onSelectTemplate, onSelectLayout } =
    templateProps
  const {
    cvList,
    currentCv,
