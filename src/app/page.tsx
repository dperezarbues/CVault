    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <p className="text-lg text-gray-500 max-w-xl mx-auto mb-10 leading-relaxed">
          A live CV editor that compiles beautiful PDFs with Typst. No accounts, no cloud — your
      ...
      <section className="max-w-5xl mx-auto px-6 py-10">
        <div className="bg-gray-900 text-white rounded-2xl px-8 py-10 text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">
            Takes 2 minutes to import your data and generate your first PDF.
          </p>
          <Link
            href="/editor"
        ...
        <div className="border border-gray-100 rounded-2xl px-6 py-5 flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex-1">
            <p className="text-sm font-semibold text-gray-900 mb-1">
              Want to understand the CV format?
            </p>
            <p className="text-sm text-gray-500 leading-relaxed">
              The schema reference documents the full JSON structure — every section type, field,
              and style option. Useful whether you&apos;re hand-editing your CV, writing a script to
              generate it, or prompting an AI assistant to produce an importable file.
            </p>
          </div>
